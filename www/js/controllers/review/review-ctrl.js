vendorView.controller('reviewCtrl', ['$scope','$timeout','$localStorage','$sessionStorage','$ionicPopup', 'IonicClosePopupService',
  function($scope, $timeout,$localStorage,$sessionStorage,$ionicPopup, IonicClosePopupService) {
    console.log('review working');
    var statusFlag = 1;
    $scope.reviewList = [
      {name: 'Mohamamad Adnan', city: 'Delhi', description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi sapiente ducimus nisi facilis aut, nam, aliquam deleniti ratione a vero itaque soluta provident, error impedit dicta et, nobis est laboriosam.', rating: 3},
      {name: 'Kanti', city: 'Gurgaon', description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi sapiente ducimus nisi facilis aut, nam, aliquam deleniti ratione a vero itaque soluta provident, error impedit dicta et, nobis est laboriosam.', rating: 2},
      {name: 'Diljeet', city: 'Dwarka', description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi sapiente ducimus nisi facilis aut, nam, aliquam deleniti ratione a vero itaque soluta provident, error impedit dicta et, nobis est laboriosam.', rating: 5},
      {name: 'Mohamamad Adnan', city: 'Delhi', description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi sapiente ducimus nisi facilis aut, nam, aliquam deleniti ratione a vero itaque soluta provident, error impedit dicta et, nobis est laboriosam.', rating: 1},
      {name: 'Mohamamad Adnan', city: 'Delhi', description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi sapiente ducimus nisi facilis aut, nam, aliquam deleniti ratione a vero itaque soluta provident, error impedit dicta et, nobis est laboriosam.', rating: 4},
      {name: 'Mohamamad Adnan', city: 'Delhi', description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi sapiente ducimus nisi facilis aut, nam, aliquam deleniti ratione a vero itaque soluta provident, error impedit dicta et, nobis est laboriosam.', rating: 2}
    ]
    ...
    // Submit Reviews In localStorage
    $scope.submit = function(data) {
      submitReviews(data);
    };
    function submitReviews(data) {
      if($localStorage.reviews) {
        $localStorage.reviews.push(data); 
      }
      else {
...
vendorView.directive('ionicRatings',function() {
  return {
    restrict: 'AE',
    replace: true,
